...
{
  "id": "sec-course-overview-2",
  "level": "2",
  "url": "syllabus.html#sec-course-overview-2",
  "type": "List",
  "number": "1",
  "title": "By the end of the semester, you should be able to:",
  "body": " By the end of the semester, you should be able to:    successfully complete computations, including solving systems of equations and computing eigenvalues.    demonstrate understanding of solving certain types of ordinary differential equations.    analyze or describe the existence\/uniqueness of a solution to a partial differential equation.    compute the partial derivatives of functions of several variables and use this to solve various problems, including optimization problems.    utilize integration you did in Calculus II to three (or more) dimensions.    "
},
{
  ...
  "body": " Grade Breakdown      Assignment Category  Percentage of Grade    Homework  20%    Class Participation (including Reflection Posts)  20%    MATLAB Labs  20%    Project  10%    Presentations  10%    Midterm Exams  20%    Final Exam  10%    "
},
{
  "id": "outline",
  "level": "1",
  ...
  "body": " Course Outline   This page provides the weekly outline for M246, including core topics, learning activities, deliverables, and recommended open educational resources (OER).    Weekly Schedule   Weekly Topics, Activities, and Deliverables    Week  Module  Topics  Activities    0  Introduction and Review  Syllabus and Course Expectations  Practice    1  Linear Algebra  Matrix operations; properties  Lecture and practice    2  Linear Algebra  Determinants; inverses; rank  Problem set    3  Linear Algebra  Systems; eigenvalues and eigenvectors  Workshop and MATLAB demo    4  Multivariable Calculus  Partial derivatives; higher-order derivatives  Lecture and concept check    5  Multivariable Calculus  Multiple integrals; vector calculus  Problem set and visualization    6  ODE  First-order ODEs (separable, linear, exact)  Lecture and stations    7  ODE  Second-order linear ODEs  Worked examples    8  ODE  Systems; Laplace transforms; numerical introduction  Lab demo and review    9  PDE  Classification; physical interpretation  Lecture and exercises    10  PDE  Heat and wave equations  Workshop and computational check    11  Applications  Model formulation  Project Proposal    12  Applications  Analytical vs. numerical methods  Progress Check    13  Applications  Computational tools; visualization  Technical Draft    14  Integration  Comprehensive review  Presentations; Final Report; Final Exam       Key Open Educational Resources   Recommended additional readings    Linear Algebra: An Interactive Introduction , Text: https:\/\/ximera.osu.edu\/oerlinalg\/LinearAlgebra    Interactive Linear Algebra , LibreTexts: https:\/\/eng.libretexts.org\/Bookshelves\/Applied_Mathematics\/Applied_Linear_Algebra_and_Differential_Equations_(EngLib)    APEX Calculus, Volume 3 : https:\/\/www.apexcalculus.com\/volume-3\/    Paul’s Online Notes: Differential Equations and PDEs : https:\/\/tutorial.math.lamar.edu\/Classes\/DE\/DE.aspx    Numerical Methods with Applications , Engineering LibreTexts: https:\/\/eng.libretexts.org\/Bookshelves\/Applied_Mathematics\/Numerical_Methods_with_Applications_(EngLib)      "
},
{
  "id": "weekly-outline-2",
  "level": "2",
  "url": "outline.html#weekly-outline-2",
  "type": "Table",
  "number": "3",
  "title": "Weekly Topics, Activities, and Deliverables",
  "body": " Weekly Topics, Activities, and Deliverables    Week  Module  Topics  Activities    0  Introduction and Review  Syllabus and Course Expectations  Practice    1  Linear Algebra  Matrix operations; properties  Lecture and practice    2  Linear Algebra  Determinants; inverses; rank  Problem set    3  Linear Algebra  Systems; eigenvalues and eigenvectors  Workshop and MATLAB demo    4  Multivariable Calculus  Partial derivatives; higher-order derivatives  Lecture and concept check    5  Multivariable Calculus  Multiple integrals; vector calculus  Problem set and visualization    6  ODE  First-order ODEs (separable, linear, exact)  Lecture and stations    7  ODE  Second-order linear ODEs  Worked examples    8  ODE  Systems; Laplace transforms; numerical introduction  Lab demo and review    9  PDE  Classification; physical interpretation  Lecture and exercises    10  PDE  Heat and wave equations  Workshop and computational check    11  Applications  Model formulation  Project Proposal    12  Applications  Analytical vs. numerical methods  Progress Check    13  Applications  Computational tools; visualization  Technical Draft    14  Integration  Comprehensive review  Presentations; Final Report; Final Exam    "
},
{
  "id": "oer-list",
  "level": "2",
  "url": "outline.html#oer-list",
  "type": "List",
  "number": "4",
  "title": "Recommended additional readings",
  "body": " Recommended additional readings    Linear Algebra: An Interactive Introduction , Text: https:\/\/ximera.osu.edu\/oerlinalg\/LinearAlgebra    Interactive Linear Algebra , LibreTexts: https:\/\/eng.libretexts.org\/Bookshelves\/Applied_Mathematics\/Applied_Linear_Algebra_and_Differential_Equations_(EngLib)    APEX Calculus, Volume 3 : https:\/\/www.apexcalculus.com\/volume-3\/    Paul’s Online Notes: Differential Equations and PDEs : https:\/\/tutorial.math.lamar.edu\/Classes\/DE\/DE.aspx    Numerical Methods with Applications , Engineering LibreTexts: https:\/\/eng.libretexts.org\/Bookshelves\/Applied_Mathematics\/Numerical_Methods_with_Applications_(EngLib)    "
},
{
  ...
  "body": " Learning Outcomes   By the end of this course, you should be able to:    Module 1: Linear Algebra Foundations   Module 1 topics:    Matrix Operations  Perform addition and scalar multiplication; compute matrix multiplication and verify dimensions; apply associative and distributive properties.    Systems of Linear Equations  Represent systems as augmented matrices; solve systems using Gaussian elimination; classify solutions as unique, infinite, or none.    Determinants and Inverses  Calculate determinants using cofactor expansion and row reduction; compute matrix inverses via row reduction; verify inverses by multiplication.    Rank and Linear Independence  Determine matrix rank using reduced row-echelon form; test linear independence of vectors; interpret rank in terms of solution existence.    Eigenvalues and Eigenvectors  Formulate the characteristic polynomial; compute eigenvalues and eigenvectors; normalize and interpret eigenvectors.    Diagonalization and Applications  Check diagonalizability; perform diagonalization using an eigenbasis; apply diagonalization to simplify ODE systems.       Module 2: Multivariable Calculus   Module 2 topics:    Partial Derivatives  Compute first and second-order partial derivatives; locate and classify critical points using the second derivative test.    Multiple Integrals  Set up double integrals over rectangular and non-rectangular regions; change the order of integration; apply change of variables; compute volume using triple integrals.    Vector Calculus  Compute gradients of scalar fields; calculate divergence and curl of vector fields and interpret their physical meaning.       Module 3: Ordinary Differential Equations (ODE)   Module 3 topics:    First-Order ODEs  Identify separable, linear, exact, and Bernoulli equations; apply the appropriate solution method; verify solutions by substitution.    Second-Order Linear ODEs  Form characteristic equations; solve for real, repeated, or complex roots; construct general solutions and apply initial conditions.    Non-Homogeneous ODEs  Identify forcing functions; apply the method of undetermined coefficients; use variation of parameters.    Systems of ODEs  Express systems in matrix form; compute eigenvalues and eigenvectors; construct solutions using linear combinations.    Special Types  Solve Cauchy–Euler equations; apply Laplace transforms for initial value problems.       Module 4: Partial Differential Equations (PDE)   Module 4 topics:    Classification  Identify order and linearity of PDEs; determine type (elliptic, parabolic, hyperbolic); explain physical meaning.    Heat Equation  Apply separation of variables; solve resulting ordinary differential equations; incorporate boundary conditions.    Wave Equation  Formulate PDEs with initial conditions; solve via separation of variables; interpret solutions physically.       Module 5: Engineering Applications and Modeling   Module 5 topics:    Model Formulation  Identify physical parameters and assumptions; translate engineering problems into mathematical models; validate models against constraints.    Analytical and Numerical Solutions  Select appropriate analytical or numerical methods; implement numerical schemes such as Euler and Runge–Kutta; compare results.    Computational Tools  Implement models in MATLAB or Python; visualize results; interpret outputs in an engineering context.      "
},
{
  "id": "learning-outcomes-list1",
  "level": "2",
  "url": "Learning-Outcomes.html#learning-outcomes-list1",
  "type": "List",
  "number": "5",
  "title": "Module 1 topics:",
  "body": " Module 1 topics:    Matrix Operations  Perform addition and scalar multiplication; compute matrix multiplication and verify dimensions; apply associative and distributive properties.    Systems of Linear Equations  Represent systems as augmented matrices; solve systems using Gaussian elimination; classify solutions as unique, infinite, or none.    Determinants and Inverses  Calculate determinants using cofactor expansion and row reduction; compute matrix inverses via row reduction; verify inverses by multiplication.    Rank and Linear Independence  Determine matrix rank using reduced row-echelon form; test linear independence of vectors; interpret rank in terms of solution existence.    Eigenvalues and Eigenvectors  Formulate the characteristic polynomial; compute eigenvalues and eigenvectors; normalize and interpret eigenvectors.    Diagonalization and Applications  Check diagonalizability; perform diagonalization using an eigenbasis; apply diagonalization to simplify ODE systems.    "
},
{
  "id": "learning-outcomes-list2",
  "level": "2",
  "url": "Learning-Outcomes.html#learning-outcomes-list2",
  "type": "List",
  "number": "6",
  "title": "Module 2 topics:",
  "body": " Module 2 topics:    Partial Derivatives  Compute first and second-order partial derivatives; locate and classify critical points using the second derivative test.    Multiple Integrals  Set up double integrals over rectangular and non-rectangular regions; change the order of integration; apply change of variables; compute volume using triple integrals.    Vector Calculus  Compute gradients of scalar fields; calculate divergence and curl of vector fields and interpret their physical meaning.    "
},
{
  "id": "learning-outcomes-list3",
  "level": "2",
  "url": "Learning-Outcomes.html#learning-outcomes-list3",
  "type": "List",
  "number": "7",
  "title": "Module 3 topics:",
  "body": " Module 3 topics:    First-Order ODEs  Identify separable, linear, exact, and Bernoulli equations; apply the appropriate solution method; verify solutions by substitution.    Second-Order Linear ODEs  Form characteristic equations; solve for real, repeated, or complex roots; construct general solutions and apply initial conditions.    Non-Homogeneous ODEs  Identify forcing functions; apply the method of undetermined coefficients; use variation of parameters.    Systems of ODEs  Express systems in matrix form; compute eigenvalues and eigenvectors; construct solutions using linear combinations.    Special Types  Solve Cauchy–Euler equations; apply Laplace transforms for initial value problems.    "
},
{
  "id": "learning-outcomes-list4",
  "level": "2",
  "url": "Learning-Outcomes.html#learning-outcomes-list4",
  "type": "List",
  "number": "8",
  "title": "Module 4 topics:",
  "body": " Module 4 topics:    Classification  Identify order and linearity of PDEs; determine type (elliptic, parabolic, hyperbolic); explain physical meaning.    Heat Equation  Apply separation of variables; solve resulting ordinary differential equations; incorporate boundary conditions.    Wave Equation  Formulate PDEs with initial conditions; solve via separation of variables; interpret solutions physically.    "
},
{
  "id": "learning-outcomes-list5",
  "level": "2",
  "url": "Learning-Outcomes.html#learning-outcomes-list5",
  "type": "List",
  "number": "9",
  "title": "Module 5 topics:",
...
},
{
  ...
  "number": "",
  "title": "",
  "body": " After completing this module, you should be able to:   Determine eigenvalues and eigenvectors of a matrix.  Relate eigenvectors to solving via row-reduction.  Use the characteristic equation to compute eigenvalues.  Distinguish algebraic and geometric multiplicities.  Determine when a matrix is diagonalizable and compute a diagonalization.  Understand similarity and its effect on eigenvalues.  Handle complex eigenvalues\/eigenvectors for real matrices.   "
},
{
...
},
{
  ...
  "number": "",
  "title": "Homework 03",
  "body": " Homework 03    Instructions: Complete all the exercises below and aim to submit your work by the due date. as for the MATLAB Lab, create an .m file titled Lab3_YourLastName.m and find eigenvalues and eigenvectors, and check that your diagonalization is correct by multiplying for your homework. This is a guided exercise to make sure you can apply the concepts that we have learned in a new setting. You may use MATLAB to double-check your calculations, but you must show your work.    Guided Practice: Eigenvalues, Eigenvectors, and Diagonalization  For each matrix, find the eigenvalues, eigenvectors, and a diagonalization of the matrix (if possible). Show all work.    Find the characteristic polynomial and set it equal 0.  The solutions of the previous step is the eigenvalues. They can be repeated, they can be real numbers as well as complex numbers. Find all of them.    Find eigenvectors corresponding to each distinct eigenvalue (if you have repeated ones , perform this step only once) by solving and then pick a non-zero solution as for each eigenvalue.  At this step you will get infinitely many solution with one or more free variables. Here is how you can pick non-zero solution: set one of the free variables to 1 and the rest to 0. This will give you a non-zero solution. Then repeat it with the rest of the free variables one by one, e.g.:     If we get enough eigenvectors this way, we can construct the matrix by putting the eigenvectors as columns and , a diagonal matrix with the eigenvalues on the diagonal in the order that corresponds to the eigenvectors in . Make sure that is invertible, otherwise the matrix is not diagonalizable.  For example if and are eigenvectors corresponding to and respectively, then      Practice Problem 1 (2×2 Matrix)  Consider the matrix     Find the characteristic polynomial and set it equal 0.  Work:  ___ _______________  ________________________________________  ________________________________________  ________________________________________    Find the eigenvalues of .   ____________   ____________    Find an eigenvector corresponding to by solving and then pick a non-zero solution as .  Work:  ________________________________________  ________________________________________   ____________________    Find an eigenvector corresponding to by solving and then pick a non-zero solution as .  Work:  ________________________________________  ________________________________________   ____________________    Construct the matrices by putting the eigenvectors as columns and , a diagonal matrix with the eigenvalues on the diagonal in the order that corresponds to the eigenvectors in . Make sure that is invertible.   ____________________   ____________________    Write the diagonalization and use MATLAB to verify it.  ________________________________________      Practice Problem 2 (3×3 Matrix)  Consider the matrix     Find the characteristic polynomial .  Work:  ________________________________________  ________________________________________    Find all eigenvalues of (they can be repeated).  ____________  ____________  ____________    Find an eigenvector corresponding to (if you have repeated eigenvalues you need to perform this step only once for them).  Work:  ________________________________________  ________________________________________  ____________________    Find an eigenvector corresponding to .  Work:  ________________________________________  ________________________________________  ____________________    Find an eigenvector corresponding to .  Work:  ________________________________________  ________________________________________  ____________________    Construct the matrix whose columns are the eigenvectors.   ____________________    Construct the diagonal matrix .   ____________________    Write the diagonalization and use MATLAB to verify it.  ________________________________________      Practice Problem 2 (3×3 Matrix)  Consider the matrix     Find the characteristic polynomial .  Work:  ________________________________________  ________________________________________    Find all eigenvalues of (they can be repeated).  ____________  ____________  ____________    Find an eigenvector corresponding to .  Work:  ________________________________________  ________________________________________  ____________________    Find an eigenvector corresponding to .  Work:  ________________________________________  ________________________________________  ____________________    Find an eigenvector corresponding to .  Work:  ________________________________________  ________________________________________  ____________________    Construct the matrix whose columns are the eigenvectors.   ____________________    Construct the diagonal matrix .   ____________________    Write the diagonalization and use MATLAB to verify it.  ________________________________________     "
},
{
  "id": "practice-2x2",
  "level": "2",
  "url": "homework-4.html#practice-2x2",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "Practice Problem 1 (2×2 Matrix).",
  "body": " Practice Problem 1 (2×2 Matrix)  Consider the matrix     Find the characteristic polynomial and set it equal 0.  Work:  ___ _______________  ________________________________________  ________________________________________  ________________________________________    Find the eigenvalues of .   ____________   ____________    Find an eigenvector corresponding to by solving and then pick a non-zero solution as .  Work:  ________________________________________  ________________________________________   ____________________    Find an eigenvector corresponding to by solving and then pick a non-zero solution as .  Work:  ________________________________________  ________________________________________   ____________________    Construct the matrices by putting the eigenvectors as columns and , a diagonal matrix with the eigenvalues on the diagonal in the order that corresponds to the eigenvectors in . Make sure that is invertible.   ____________________   ____________________    Write the diagonalization and use MATLAB to verify it.  ________________________________________    "
},
{
  "id": "practice-3x3",
  "level": "2",
  "url": "homework-4.html#practice-3x3",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "Practice Problem 2 (3×3 Matrix).",
  "body": " Practice Problem 2 (3×3 Matrix)  Consider the matrix     Find the characteristic polynomial .  Work:  ________________________________________  ________________________________________    Find all eigenvalues of (they can be repeated).  ____________  ____________  ____________    Find an eigenvector corresponding to (if you have repeated eigenvalues you need to perform this step only once for them).  Work:  ________________________________________  ________________________________________  ____________________    Find an eigenvector corresponding to .  Work:  ________________________________________  ________________________________________  ____________________    Find an eigenvector corresponding to .  Work:  ________________________________________  ________________________________________  ____________________    Construct the matrix whose columns are the eigenvectors.   ____________________    Construct the diagonal matrix .   ____________________    Write the diagonalization and use MATLAB to verify it.  ________________________________________    "
},
{
  "id": "practice2-3x3",
  "level": "2",
  "url": "homework-4.html#practice2-3x3",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "Practice Problem 2 (3×3 Matrix).",
  "body": " Practice Problem 2 (3×3 Matrix)  Consider the matrix     Find the characteristic polynomial .  Work:  ________________________________________  ________________________________________    Find all eigenvalues of (they can be repeated).  ____________  ____________  ____________    Find an eigenvector corresponding to .  Work:  ________________________________________  ________________________________________  ____________________    Find an eigenvector corresponding to .  Work:  ________________________________________  ________________________________________  ____________________    Find an eigenvector corresponding to .  Work:  ________________________________________  ________________________________________  ____________________    Construct the matrix whose columns are the eigenvectors.   ____________________    Construct the diagonal matrix .   ____________________    Write the diagonalization and use MATLAB to verify it.  ________________________________________    "
